...
import { Loader2, Mail, Lock, User, Sparkles, Gift } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#08080a] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-6 p-4 rounded-xl bg-orange-500/10 border border-orange-500/30 flex items-center gap-3">
          ...
          <div>
            <p className="text-orange-400 font-medium">3 Free Credits</p>
            <p className="text-orange-400/70 text-sm">Sign up and get 3 free headshot generations</p>
          </div>
        </div>
